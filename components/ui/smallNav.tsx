            ...
            <div className="flex items-center">
                <Sheet>
                    ...
                    <SheetContent>
                        ...
                        <Link className="mx-2 my-4 border rounded-lg flex justify-center relative" href={'/sign-in'}>
                            <Button className="flex items-center gap-4 text-blue-500 text-xl w-full h-full" variant="ghost">
                        ...
                        <div className="mx-2 mt-2 h-fit border rounded-lg pt-2 pb-14 px-4">
